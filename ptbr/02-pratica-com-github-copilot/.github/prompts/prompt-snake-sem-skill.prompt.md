# Prompt: Snake Game SEM Skill de Frontend Design

## Instrução para o GitHub Copilot (sem nenhuma skill ativada)

> **Nota:** Este prompt é usado SEM a skill `frontend-design` e SEM a instruction `html-css-style-color-guide`, para comparar o resultado visual com a versão que usa a skill.
...
**Pasta de destino:** Salve o arquivo gerado na pasta `snake-sem-skill/` na raiz do projeto (caminho: `snake-sem-skill/index.html`).

Faça um design bonito e agradável para o jogo.
